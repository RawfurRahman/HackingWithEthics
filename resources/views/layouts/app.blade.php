                    ...
                    <div class="sidebar-inner slimscrollleft">
                        ...
                        <div id="sidebar-menu">
                            <ul>
                                ...
                                <li class="has_sub">
                                    <a href="#" class="waves-effect"><i class="md md-mail"></i><span> Authors </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                    <ul class="list-unstyled">
                                        <li><a href="{{ route('add_author') }}">Add Authors</a></li>
            ...
            $(document).on("click", "#delete", function(e){
                ...
                var link = $(this).attr("herf");
                    swal({
                        ...
                        text:       "Once delete it will be permanent delete",
                        icon:       "Warning",
                        buttons:    true,
                        dangerMode: true,
                    })
